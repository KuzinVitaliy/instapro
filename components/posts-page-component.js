...
function GetHostHtml(userID, userImageUrl, userName, imageUrl, postId, postDate, likeIsActive) {

  let likeImage = 'like-not-active.svg'
  if (likeIsActive)  likeImage = "like-active.svg";

  let postDateText =  postDate;
  return `<li class="post">
                    <div class="post-header" data-user-id="${userID}">
                        <img src="${userImageUrl}" class="post-header__user-image">
